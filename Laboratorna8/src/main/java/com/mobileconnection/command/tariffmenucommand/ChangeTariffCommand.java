        ...
        while(true) {
            ...
            for (int i = 0; i < fields.length; i++)
                try {
                    ...
                    MyLogger.logger.severe("Помилка доступу!");
                }
            ...
            try {
                ...
                choice = -1;
                MyLogger.logger.severe("Помилка введення даних!");
            }
            ...
            if (choice > 0 && choice <= fields.length) {
                ...
                MyLogger.logger.info("Поле \"" + fields[choice - 1].getName() + "\" тарифу \"" + getCurrentTariff().getName() + "\" змінено!");
            }
        }
        for (Field field : fields)
