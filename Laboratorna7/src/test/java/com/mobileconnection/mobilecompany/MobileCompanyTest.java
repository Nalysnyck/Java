...
public class MobileCompanyTest {
    ...
    public void testSortTwoTariffs(){
        ...
        assertEquals(mobileCompany.getTariffs()[0], tariffs[1]);
        assertEquals(mobileCompany.getTariffs()[1], tariffs[0]);
    }
    ...
    public void testSortThreeTariffs(){
        ...
        mobileCompany.sortTariffs();
        assertEquals(mobileCompany.getTariffs()[0], tariffs[1]);
        assertEquals(mobileCompany.getTariffs()[1], tariffs[2]);
        assertEquals(mobileCompany.getTariffs()[2], tariffs[0]);
    }
